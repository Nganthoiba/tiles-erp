...
class SalesService
{
     ...
     */
    public function convertToInvoice(Quotation $quotation, array $additionalData = []): SalesInvoice
    {
        ...
        return DB::transaction(function () use ($quotation, $additionalData) {
            ...
            foreach ($quotation->items as $item) {
                ...
                $warehouse = \App\Modules\Inventory\Models\Warehouse::findOrFail($warehouseId);
