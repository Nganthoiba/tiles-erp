...
use App\Modules\Logistics\Models\DeliverySlipItem;
...
class LogisticsService
{
     ...
     */
    public function createSlipFromInvoice(SalesInvoice $invoice, array $data): DeliverySlip
    {
     ...
     */
    public function updateStatus(DeliverySlip $slip, string $status, array $extraData = []): DeliverySlip
    {
        $slip->status = $status;
